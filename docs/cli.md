...
| `iva remind <text>`                | Let the agent judge one reminder request in your words and send its answer to the owner chat; on a turn failure the raw text still goes out. Scheduled reminders use the reminder tools ([reminders.md](./reminders.md))                                                                                                                                                              |
